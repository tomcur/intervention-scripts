...
# Run Carla and a student and teacher model to collect on-policy driving data with interventions.

#SBATCH --partition=gpu
#SBATCH --job-name=int-intervention-policy
#SBATCH --nodes=1
...
case "$1" in
    ...
    "intervention")
        ...
        LD_LIBRARY_PATH="${CONDA_PREFIX}/lib" \
            ...
            -s "${INTERVENTION_STUDENT_CHECKPOINT}" \
